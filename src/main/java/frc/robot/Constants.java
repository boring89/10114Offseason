...
public final class Constants {
  ...
  new ModuleLimits(kPhysicalMaxSpeedMetersPerSecond , kTeleDriveMaxAccelerationUnitsPerSec, Units.degreesToRadians(1080.0));
  ...
  public static final class VisionConstants {
    ...
    public static final double kTargetA = 0.0;
  }

  public static final class ArmConstants {
    public static final int kFLMotorPort = 14;
    public static final int kFRMotorPort = 15;
    public static final int kBLMotorPort = 16;
    public static final int kBRMotorPort = 17;

    public static final int kArmCANcoderPort = 18;

    public static final double kP = 0;
    public static final double kI = 0;
    public static final double kD = 0;

    public static final double kArmGearRatio = 123.456789;

    public static final double kArmMaxAngle = 180;
