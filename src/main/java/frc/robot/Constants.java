...
public final class Constants {
  ...
  public static final class Positions { // {pivot, Hand, Elevator}
    ...
    public static final double[] kL1 = { 6.1, 18.1, 0.0 };
    public static final double[] kL2 = { 9.23, 17.5, 0.75 };
    public static final double[] kL3 = { 27.7, 18,  2.3};
    public static final double[] kL4 = { 27.7, 21.7, 15.2 };

    public static final double[] kProcessor = { 7.0, 3.38, 0.0 };
    public static final double[] kNet = { 26.35, 3.75, 15.64 };

    public static final double[] kCoralStand = { 11.75, 17.0, 0.0 };
    public static final double[] kAlgaeStand = { 19.0, 9.41, 0.0 };

    public static final double[] kWait = { 11.75, 21.0, 0.0 };
  }
}
