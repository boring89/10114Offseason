...
public class RightReefCmd extends Command{
    ...
    public RightReefCmd(SwerveSubsystem swerveSubsystem, Limelight limelight) {
    ...
    @Override
    public void execute() {
        tx = limelight.getRightX();
        ta = limelight.getRightA();
        yaw = limelight.getRightPose();
