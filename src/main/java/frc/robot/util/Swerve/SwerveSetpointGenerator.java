...
import frc.robot.util.Swerve.SwervesetpointCalculate.EqualsUtil;
import frc.robot.util.Swerve.SwervesetpointCalculate.GeomUtil;

import static frc.robot.util.Swerve.SwervesetpointCalculate.EqualsUtil.*;
